        ...
        <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div>
                ...
                <div class="flex items-center gap-4 mb-3">
                    <img src="{{ Str::startsWith($product->image_path, ['http', 'data:']) ? $product->image_path : asset($product->image_path) }}" class="w-20 h-20 object-cover rounded border border-gray-300">
